...
options := ["new_path", "range", "attack", "cooldown", "explosive_death", "shield", "speed", "yen", "regen", "health"]
...
global priorityOrder := ["new_path", "range", "attack", "cooldown", "explosive_death", "shield", "speed", "yen", "regen", "health"]
